...
// @generated from file types/scan.proto (package aiscan.scan, syntax proto3)
/* eslint-disable */
 ...
 *
 * @generated from message aiscan.scan.ScanProtocolMessage
 */
export type ScanProtocolMessage = Message<"aiscan.scan.ScanProtocolMessage"> & {
  /**
   * @generated from oneof aiscan.scan.ScanProtocolMessage.message
   */
  message: {
    /**
...
/**
 * Describes the message aiscan.scan.ScanProtocolMessage.
