...
| `aiscan-full` | Linux amd64/arm64、macOS amd64/arm64、Windows amd64 | standard + Web、Playwright、passive、katana；Linux/Windows 支持原生录屏 |

macOS full 包含 Web、浏览器和被动测绘能力，但不包含原生录屏。Windows arm64 只发布 standard。
