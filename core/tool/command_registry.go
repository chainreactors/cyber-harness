...
func (r *CommandRegistry) Load(scope *extension.Scope) error {
...
func (r *CommandRegistry) Close(ctx context.Context) error {
...
func (r *CommandRegistry) Get(name string) (*types.CommandSpec, bool) {
	if r == nil || r.store == nil {
		return nil, false
	}
...
func (r *CommandRegistry) All() []*types.CommandSpec {
	if r == nil || r.store == nil {
		return nil
	}
...
func (r *CommandRegistry) DescriptionPath(name string) string {
	if r == nil || r.store == nil {
		return ""
	}
	entry, exists := r.store.Get(name)
...
func (r *CommandRegistry) Run(ctx context.Context, tokens []string, parent *Execution) (any, error) {
	if len(tokens) == 0 {
...
var _ extension.Extension = (*CommandRegistry)(nil)
var _ resource.Point[Command] = (*CommandRegistry)(nil)
