...
func (t *workspaceReadTool) audited(ctx context.Context, path string, size int64, result *coretool.Result, err error) (*coretool.Result, error) {
	if err == nil {
...
func newWorkspaceReadTool(workDir string, audit *fileaudit.Audit, readers ...VirtualFileReader) *workspaceReadTool {
	return &workspaceReadTool{workDir: workDir, readers: readers, audit: audit}
}

func (t *workspaceReadTool) Name() string { return "read" }
...
func (t *workspaceReadTool) Definition() *coretool.Definition {
	return coretool.Def("read", t.Description(), ReadArgs{})
}

func (t *workspaceReadTool) Execute(ctx context.Context, arguments string) (*coretool.Result, error) {
	effective := *t
...
func (t *workspaceReadTool) readFileLines(resolved, displayPath string, offset, limit int) (*coretool.Result, error) {
...
func (t *workspaceReadTool) readVirtual(args ReadArgs) (*coretool.Result, error) {
...
func (t *workspaceReadTool) tryVirtualFallback(path string) (*coretool.Result, bool) {
	for _, reader := range t.readers {
		if reader == nil {
			continue
		}
...
func (t *workspaceReadTool) paginateString(content, displayPath string, offset, limit int) *coretool.Result {
...
func (t *workspaceReadTool) resolvePath(path string) string {
...
func readImageFile(resolved, displayPath, mime string, size int64) (*coretool.Result, error) {
	...
	opt, err := imageutil.Optimize(f, mime)
	if err != nil {
