...
func runRemoteConsole(ctx context.Context, rt *runtimepkg.AgentRuntime, session *runtimepkg.Session, option *cfg.Option, input io.Reader, output io.Writer, control *rlterm.StreamControl) error {
	if control == nil {
