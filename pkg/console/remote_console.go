...
func runRemoteConsole(ctx context.Context, rt *sessionext.Manager, session *sessionext.Session, option *cfg.Option, input io.Reader, output io.Writer, control *rlterm.StreamControl) error {
	if control == nil {
