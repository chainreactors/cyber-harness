...
import (
	...
	context "context"
	errors "errors"
	system1 "github.com/chainreactors/aiscan/pkg/rpc/system"
...
type SystemServiceClient interface {
	GetStatus(context.Context, *connect.Request[system.GetStatusRequest]) (*connect.Response[system.GetStatusResponse], error)
}
...
func NewSystemServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SystemServiceClient {
	...
	systemServiceMethods := system1.File_aiscan_rpc_system_proto.Services().ByName("SystemService").Methods()
	return &systemServiceClient{
		getStatus: connect.NewClient[system.GetStatusRequest, system.GetStatusResponse](
			httpClient,
...
type systemServiceClient struct {
	getStatus *connect.Client[system.GetStatusRequest, system.GetStatusResponse]
}

// GetStatus calls aiscan.rpc.system.SystemService.GetStatus.
func (c *systemServiceClient) GetStatus(ctx context.Context, req *connect.Request[system.GetStatusRequest]) (*connect.Response[system.GetStatusResponse], error) {
...
func (UnimplementedSystemServiceHandler) GetStatus(context.Context, *connect.Request[system.GetStatusRequest]) (*connect.Response[system.GetStatusResponse], error) {
