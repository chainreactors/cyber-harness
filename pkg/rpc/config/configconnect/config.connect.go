...
import (
	...
	context "context"
	errors "errors"
	config1 "github.com/chainreactors/aiscan/pkg/rpc/config"
...
type ConfigServiceClient interface {
	GetConfig(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[config.GetConfigResponse], error)
	UpdateConfig(context.Context, *connect.Request[config.UpdateConfigRequest]) (*connect.Response[config.UpdateConfigResponse], error)
	ActivateProfile(context.Context, *connect.Request[config.ActivateProfileRequest]) (*connect.Response[config.ActivateProfileResponse], error)
	TestLLM(context.Context, *connect.Request[config.LLMProbeRequest]) (*connect.Response[config.LLMProbeResult], error)
	ListModels(context.Context, *connect.Request[config.LLMProbeRequest]) (*connect.Response[config.ListModelsResult], error)
	TestConnection(context.Context, *connect.Request[config.TestConnectionRequest]) (*connect.Response[config.TestConnectionResponse], error)
}
...
func NewConfigServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConfigServiceClient {
	...
	configServiceMethods := config1.File_aiscan_rpc_config_proto.Services().ByName("ConfigService").Methods()
	return &configServiceClient{
		getConfig: connect.NewClient[emptypb.Empty, config.GetConfigResponse](
			httpClient,
			baseURL+ConfigServiceGetConfigProcedure,
			connect.WithSchema(configServiceMethods.ByName("GetConfig")),
			connect.WithClientOptions(opts...),
		),
		updateConfig: connect.NewClient[config.UpdateConfigRequest, config.UpdateConfigResponse](
			httpClient,
			baseURL+ConfigServiceUpdateConfigProcedure,
			connect.WithSchema(configServiceMethods.ByName("UpdateConfig")),
			connect.WithClientOptions(opts...),
		),
		activateProfile: connect.NewClient[config.ActivateProfileRequest, config.ActivateProfileResponse](
			httpClient,
			baseURL+ConfigServiceActivateProfileProcedure,
			connect.WithSchema(configServiceMethods.ByName("ActivateProfile")),
			connect.WithClientOptions(opts...),
		),
		testLLM: connect.NewClient[config.LLMProbeRequest, config.LLMProbeResult](
			httpClient,
			baseURL+ConfigServiceTestLLMProcedure,
			connect.WithSchema(configServiceMethods.ByName("TestLLM")),
			connect.WithClientOptions(opts...),
		),
		listModels: connect.NewClient[config.LLMProbeRequest, config.ListModelsResult](
			httpClient,
			baseURL+ConfigServiceListModelsProcedure,
			connect.WithSchema(configServiceMethods.ByName("ListModels")),
			connect.WithClientOptions(opts...),
		),
		testConnection: connect.NewClient[config.TestConnectionRequest, config.TestConnectionResponse](
			httpClient,
...
type configServiceClient struct {
	getConfig       *connect.Client[emptypb.Empty, config.GetConfigResponse]
	updateConfig    *connect.Client[config.UpdateConfigRequest, config.UpdateConfigResponse]
	activateProfile *connect.Client[config.ActivateProfileRequest, config.ActivateProfileResponse]
	testLLM         *connect.Client[config.LLMProbeRequest, config.LLMProbeResult]
	listModels      *connect.Client[config.LLMProbeRequest, config.ListModelsResult]
	testConnection  *connect.Client[config.TestConnectionRequest, config.TestConnectionResponse]
}

// GetConfig calls aiscan.rpc.config.ConfigService.GetConfig.
func (c *configServiceClient) GetConfig(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[config.GetConfigResponse], error) {
	return c.getConfig.CallUnary(ctx, req)
}

// UpdateConfig calls aiscan.rpc.config.ConfigService.UpdateConfig.
func (c *configServiceClient) UpdateConfig(ctx context.Context, req *connect.Request[config.UpdateConfigRequest]) (*connect.Response[config.UpdateConfigResponse], error) {
	return c.updateConfig.CallUnary(ctx, req)
}

// ActivateProfile calls aiscan.rpc.config.ConfigService.ActivateProfile.
func (c *configServiceClient) ActivateProfile(ctx context.Context, req *connect.Request[config.ActivateProfileRequest]) (*connect.Response[config.ActivateProfileResponse], error) {
	return c.activateProfile.CallUnary(ctx, req)
}

// TestLLM calls aiscan.rpc.config.ConfigService.TestLLM.
func (c *configServiceClient) TestLLM(ctx context.Context, req *connect.Request[config.LLMProbeRequest]) (*connect.Response[config.LLMProbeResult], error) {
	return c.testLLM.CallUnary(ctx, req)
}

// ListModels calls aiscan.rpc.config.ConfigService.ListModels.
func (c *configServiceClient) ListModels(ctx context.Context, req *connect.Request[config.LLMProbeRequest]) (*connect.Response[config.ListModelsResult], error) {
	return c.listModels.CallUnary(ctx, req)
}

// TestConnection calls aiscan.rpc.config.ConfigService.TestConnection.
func (c *configServiceClient) TestConnection(ctx context.Context, req *connect.Request[config.TestConnectionRequest]) (*connect.Response[config.TestConnectionResponse], error) {
...
func (UnimplementedConfigServiceHandler) GetConfig(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[config.GetConfigResponse], error) {
...
func (UnimplementedConfigServiceHandler) UpdateConfig(context.Context, *connect.Request[config.UpdateConfigRequest]) (*connect.Response[config.UpdateConfigResponse], error) {
...
func (UnimplementedConfigServiceHandler) ActivateProfile(context.Context, *connect.Request[config.ActivateProfileRequest]) (*connect.Response[config.ActivateProfileResponse], error) {
...
func (UnimplementedConfigServiceHandler) TestLLM(context.Context, *connect.Request[config.LLMProbeRequest]) (*connect.Response[config.LLMProbeResult], error) {
...
func (UnimplementedConfigServiceHandler) ListModels(context.Context, *connect.Request[config.LLMProbeRequest]) (*connect.Response[config.ListModelsResult], error) {
...
func (UnimplementedConfigServiceHandler) TestConnection(context.Context, *connect.Request[config.TestConnectionRequest]) (*connect.Response[config.TestConnectionResponse], error) {
