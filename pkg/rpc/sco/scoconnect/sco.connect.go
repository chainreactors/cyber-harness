...
import (
	...
	context "context"
	errors "errors"
	sco1 "github.com/chainreactors/aiscan/pkg/rpc/sco"
...
type SCOServiceClient interface {
	ListNodes(context.Context, *connect.Request[sco.ListNodesRequest]) (*connect.Response[sco.ListNodesResponse], error)
	GetNode(context.Context, *connect.Request[sco.GetNodeRequest]) (*connect.Response[sco.GetNodeResponse], error)
	GetStats(context.Context, *connect.Request[sco.GetStatsRequest]) (*connect.Response[sco.GetStatsResponse], error)
	DeleteNodes(context.Context, *connect.Request[sco.DeleteNodesRequest]) (*connect.Response[sco.DeleteNodesResponse], error)
	ImportNodes(context.Context, *connect.Request[sco.ImportNodesRequest]) (*connect.Response[sco.ImportNodesResponse], error)
	ListArtifacts(context.Context, *connect.Request[sco.ListArtifactsRequest]) (*connect.Response[sco.ListArtifactsResponse], error)
}
...
func NewSCOServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SCOServiceClient {
	...
	sCOServiceMethods := sco1.File_aiscan_rpc_sco_proto.Services().ByName("SCOService").Methods()
	return &sCOServiceClient{
		listNodes: connect.NewClient[sco.ListNodesRequest, sco.ListNodesResponse](
			httpClient,
			baseURL+SCOServiceListNodesProcedure,
			connect.WithSchema(sCOServiceMethods.ByName("ListNodes")),
			connect.WithClientOptions(opts...),
		),
		getNode: connect.NewClient[sco.GetNodeRequest, sco.GetNodeResponse](
			httpClient,
			baseURL+SCOServiceGetNodeProcedure,
			connect.WithSchema(sCOServiceMethods.ByName("GetNode")),
			connect.WithClientOptions(opts...),
		),
		getStats: connect.NewClient[sco.GetStatsRequest, sco.GetStatsResponse](
			httpClient,
			baseURL+SCOServiceGetStatsProcedure,
			connect.WithSchema(sCOServiceMethods.ByName("GetStats")),
			connect.WithClientOptions(opts...),
		),
		deleteNodes: connect.NewClient[sco.DeleteNodesRequest, sco.DeleteNodesResponse](
			httpClient,
			baseURL+SCOServiceDeleteNodesProcedure,
			connect.WithSchema(sCOServiceMethods.ByName("DeleteNodes")),
			connect.WithClientOptions(opts...),
		),
		importNodes: connect.NewClient[sco.ImportNodesRequest, sco.ImportNodesResponse](
			httpClient,
			baseURL+SCOServiceImportNodesProcedure,
			connect.WithSchema(sCOServiceMethods.ByName("ImportNodes")),
			connect.WithClientOptions(opts...),
		),
		listArtifacts: connect.NewClient[sco.ListArtifactsRequest, sco.ListArtifactsResponse](
			httpClient,
...
type sCOServiceClient struct {
	listNodes     *connect.Client[sco.ListNodesRequest, sco.ListNodesResponse]
	getNode       *connect.Client[sco.GetNodeRequest, sco.GetNodeResponse]
	getStats      *connect.Client[sco.GetStatsRequest, sco.GetStatsResponse]
	deleteNodes   *connect.Client[sco.DeleteNodesRequest, sco.DeleteNodesResponse]
	importNodes   *connect.Client[sco.ImportNodesRequest, sco.ImportNodesResponse]
	listArtifacts *connect.Client[sco.ListArtifactsRequest, sco.ListArtifactsResponse]
}

// ListNodes calls aiscan.rpc.sco.SCOService.ListNodes.
func (c *sCOServiceClient) ListNodes(ctx context.Context, req *connect.Request[sco.ListNodesRequest]) (*connect.Response[sco.ListNodesResponse], error) {
	return c.listNodes.CallUnary(ctx, req)
}

// GetNode calls aiscan.rpc.sco.SCOService.GetNode.
func (c *sCOServiceClient) GetNode(ctx context.Context, req *connect.Request[sco.GetNodeRequest]) (*connect.Response[sco.GetNodeResponse], error) {
	return c.getNode.CallUnary(ctx, req)
}

// GetStats calls aiscan.rpc.sco.SCOService.GetStats.
func (c *sCOServiceClient) GetStats(ctx context.Context, req *connect.Request[sco.GetStatsRequest]) (*connect.Response[sco.GetStatsResponse], error) {
	return c.getStats.CallUnary(ctx, req)
}

// DeleteNodes calls aiscan.rpc.sco.SCOService.DeleteNodes.
func (c *sCOServiceClient) DeleteNodes(ctx context.Context, req *connect.Request[sco.DeleteNodesRequest]) (*connect.Response[sco.DeleteNodesResponse], error) {
	return c.deleteNodes.CallUnary(ctx, req)
}

// ImportNodes calls aiscan.rpc.sco.SCOService.ImportNodes.
func (c *sCOServiceClient) ImportNodes(ctx context.Context, req *connect.Request[sco.ImportNodesRequest]) (*connect.Response[sco.ImportNodesResponse], error) {
	return c.importNodes.CallUnary(ctx, req)
}

// ListArtifacts calls aiscan.rpc.sco.SCOService.ListArtifacts.
func (c *sCOServiceClient) ListArtifacts(ctx context.Context, req *connect.Request[sco.ListArtifactsRequest]) (*connect.Response[sco.ListArtifactsResponse], error) {
...
func (UnimplementedSCOServiceHandler) ListNodes(context.Context, *connect.Request[sco.ListNodesRequest]) (*connect.Response[sco.ListNodesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aiscan.rpc.sco.SCOService.ListNodes is not implemented"))
}

func (UnimplementedSCOServiceHandler) GetNode(context.Context, *connect.Request[sco.GetNodeRequest]) (*connect.Response[sco.GetNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aiscan.rpc.sco.SCOService.GetNode is not implemented"))
}

func (UnimplementedSCOServiceHandler) GetStats(context.Context, *connect.Request[sco.GetStatsRequest]) (*connect.Response[sco.GetStatsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aiscan.rpc.sco.SCOService.GetStats is not implemented"))
}

func (UnimplementedSCOServiceHandler) DeleteNodes(context.Context, *connect.Request[sco.DeleteNodesRequest]) (*connect.Response[sco.DeleteNodesResponse], error) {
...
func (UnimplementedSCOServiceHandler) ImportNodes(context.Context, *connect.Request[sco.ImportNodesRequest]) (*connect.Response[sco.ImportNodesResponse], error) {
...
func (UnimplementedSCOServiceHandler) ListArtifacts(context.Context, *connect.Request[sco.ListArtifactsRequest]) (*connect.Response[sco.ListArtifactsResponse], error) {
