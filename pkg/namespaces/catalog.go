...
// Catalog is the Point for connection namespace bindings. Each connection
...
func New() *Catalog {
	return &Catalog{values: make(map[protoreflect.FullName]aop.NamespaceBinding)}
}

func (c *Catalog) Load(scope *extension.Scope) error {
	if c == nil || scope == nil {
		return fmt.Errorf("namespace catalog is unavailable")
	}
	return extension.Define[aop.NamespaceBinding](scope, c)
}

func (c *Catalog) Add(values ...aop.NamespaceBinding) (resource.Handle, error) {
...
func (c *Catalog) Bind(mux *aop.NamespaceMux) error {
	if c == nil || mux == nil {
		return fmt.Errorf("namespace catalog and mux are required")
	}
	c.mu.RLock()
...
var (
	_ extension.Extension                  = (*Catalog)(nil)
	_ resource.Point[aop.NamespaceBinding] = (*Catalog)(nil)
)
