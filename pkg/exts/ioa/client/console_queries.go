...
func RunIOASpaces(ctx context.Context, client ioatools.Reader, option *ConsoleOptions, stdout, stderr io.Writer) error {
...
func RunIOAMessages(ctx context.Context, client ioatools.Reader, option *ConsoleOptions, args ConsoleArgs, stdout, stderr io.Writer) error {
...
func RunIOAContext(ctx context.Context, client ioatools.Reader, option *ConsoleOptions, args ConsoleArgs, stdout, stderr io.Writer) error {
	space, err := client.ResolveSpace(ctx, args.Space)
	if err != nil {
		return err
	}
...
func RunIOANodes(ctx context.Context, client ioatools.Reader, option *ConsoleOptions, args ConsoleArgs, stdout, stderr io.Writer) error {
	if args.Space != "" {
		space, err := client.ResolveSpace(ctx, args.Space)
		if err != nil {
			return err
...
func (r *presentation) renderIOASpaces(ctx context.Context, client ioatools.Reader) error {
	spaces, err := client.ListSpaces(ctx)
	if err != nil {
		return err
	}
...
func (r *presentation) renderIOANodes(ctx context.Context, client ioatools.Reader, space string) error {
	if space != "" {
...
func (r *presentation) renderIOAMessages(ctx context.Context, client ioatools.Reader, space string) error {
	sp, err := client.ResolveSpace(ctx, space)
	if err != nil {
		return err
	}
...
func (r *presentation) printBoxTable(title string, rows [][]string) { r.view.Table(title, rows) }
...
type ConsoleOptions struct{ JSON bool }
type ConsoleArgs struct{ Space, MessageID string }
type presentation struct {
	view           consoleapi.View
