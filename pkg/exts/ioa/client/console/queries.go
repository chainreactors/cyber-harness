...
func RunIOASpaces(ctx context.Context, client ioatools.Reader, option *Options, stdout, stderr io.Writer) error {
...
func RunIOAMessages(ctx context.Context, client ioatools.Reader, option *Options, args Args, stdout, stderr io.Writer) error {
...
func RunIOAContext(ctx context.Context, client ioatools.Reader, option *Options, args Args, stdout, stderr io.Writer) error {
	space, err := client.ResolveSpace(ctx, args.Space)
	if err != nil {
		return err
	}
...
func RunIOANodes(ctx context.Context, client ioatools.Reader, option *Options, args Args, stdout, stderr io.Writer) error {
	if args.Space != "" {
		space, err := client.ResolveSpace(ctx, args.Space)
		if err != nil {
			return err
...
type Args struct{ Space, MessageID string }
