...
func Bind(reader ioatools.Reader, space, endpoint string) *consoleapi.Bindings {
	...
	return []*cobra.Command{
		...
		},
		{
			...
			RunE: func(c *cobra.Command, args []string) error {
				...
				client := reader
				return RunIOAContext(ctx, client, &Options{}, Args{Space: fields[0], MessageID: fields[1]}, r.stdout, r.stderr)
			},
		},
		{
