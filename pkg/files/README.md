...
`files.FS` owns an `os.Root`, path policy and admitted operations. It implements
...
| `pkg/toolset/filetools` | bounded tool extension | read/write/list registrations; borrows `files.FS` |
