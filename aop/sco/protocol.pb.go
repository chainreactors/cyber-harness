...
func (x *ProtocolMessage) GetNodes() *Nodes {
	if x, ok := x.GetMessage().(*ProtocolMessage_Nodes); ok {
		return x.Nodes
	}
	return nil
}
...
var file_aop_sco_protocol_proto_rawDesc = []byte{
	0x0a, 0x16, 0x61, 0x6f, 0x70, 0x2f, 0x73, 0x63, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63,
	0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x61, 0x6f, 0x70, 0x2e, 0x73, 0x63,
	0x6f, 0x22, 0x3c, 0x0a, 0x05, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f,
	...
	0x44, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x26, 0x0a, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0e, 0x2e, 0x61, 0x6f, 0x70, 0x2e, 0x73, 0x63, 0x6f, 0x2e, 0x4e, 0x6f, 0x64, 0x65,
	0x73, 0x48, 0x00, 0x52, 0x05, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65,
	...
	0x73, 0x2f, 0x61, 0x69, 0x73, 0x63, 0x61, 0x6e, 0x2f, 0x61, 0x6f, 0x70, 0x2f, 0x73, 0x63, 0x6f,
	0x3b, 0x73, 0x63, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_aop_sco_protocol_proto_rawDescOnce sync.Once
	file_aop_sco_protocol_proto_rawDescData = file_aop_sco_protocol_proto_rawDesc
)

func file_aop_sco_protocol_proto_rawDescGZIP() []byte {
	file_aop_sco_protocol_proto_rawDescOnce.Do(func() {
		file_aop_sco_protocol_proto_rawDescData = protoimpl.X.CompressGZIP(file_aop_sco_protocol_proto_rawDescData)
	})
	return file_aop_sco_protocol_proto_rawDescData
}

var file_aop_sco_protocol_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_aop_sco_protocol_proto_goTypes = []interface{}{
...
func file_aop_sco_protocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aop_sco_protocol_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Nodes); i {
			case 0:
				return &v.state
			case 1:
		...
		file_aop_sco_protocol_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_aop_sco_protocol_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_aop_sco_protocol_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_aop_sco_protocol_proto_rawDesc = nil
